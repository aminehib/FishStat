...
public class RegressionPoly2Unit {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Test 1 : coeff a (x^2) attendu 1.0  obtenu " + coeffs[1]);
        if (coeffs[1] != null && Math.abs(coeffs[1] - 1.0) < 1e-6) { System.out.println("  [OK]"); ok++; } else { System.out.println("  [KO]"); ko++; }

        System.out.println("Test 2 : coeff b (x) attendu 2.0  obtenu " + coeffs[0]);
        if (coeffs[0] != null && Math.abs(coeffs[0] - 2.0) < 1e-6) { System.out.println("  [OK]"); ok++; } else { System.out.println("  [KO]"); ko++; }
